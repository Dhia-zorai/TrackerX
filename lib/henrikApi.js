...
// size max 10 per request; page is 0-indexed
export async function henrikGetMatchesByPuuid(puuid, region = "na", size = 10, page = 0) {
  const r = HENRIK_REGIONS[region] || "na";
  return henrikFetch(`/valorant/v3/by-puuid/matches/${r}/${puuid}?size=${size}&page=${page}`);
}
