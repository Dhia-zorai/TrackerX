...
export default function PlayerSearch({ compact = false }) {
  ...
  const outerCls = "flex items-center gap-1.5 sm:gap-2 glass-accent rounded-xl p-1 overflow-hidden transition-all duration-200 focus-within:border-[var(--accent)] " + (compact ? "h-10" : "h-14");
